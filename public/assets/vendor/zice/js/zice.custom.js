...
$(document).ready(function(){	
	...
	// WYSIWYG Editor
	$(".wysiwyg,#editor,#editor2").cleditor();	
...
$('.searchAutocomplete').click(function() {
 $('.searchText').toggle('slow', function() {
	...
	$('.logout').live('click',function() { 
		  ...
		  loading(str,overlay);
		  setTimeout("unloading()",1500);
		  setTimeout( "window.location.href='/auth/signout/admin'", 2000 );
	  });
 ...
 function Processgraph(){
	...
	// mutiupload
	  ...
	  $('#uploadify').uploadify({
	  'uploader'  : '/assets/vendor/zice/components/uploadify/uploadify.swf',
	  'script'    : '/assets/vendor/zice/components/uploadify/uploadify.php',
	  'cancelImg' : '/assets/vendor/zice/components/uploadify/cancel.png',
	  'folder'    : 'uploads',
	  'method'	: 'GET',
	...
	$('.iconBox.gray').hover(function(){
		  ...
		  $(this).find('img').animate({ opacity: 0.5 }, 0, function(){
			    $(this).attr('src','/assets/vendor/zice/images/icon/color_18/'+name+'.png').animate({ opacity: 1 }, 700);									 
		 });
	},function(){
		  var name=$(this).find('img').attr('alt');
		  $(this).find('img').attr('src','/assets/vendor/zice/images/icon/gray_18/'+name+'.png');
	 })
	...
	$('div.logout').hover(function(){
		  ...
		  $(this).find('img').animate({ opacity: 0.4 }, 200, function(){
			    $(this).attr('src','/assets/vendor/zice/images/'+name+'.png').animate({ opacity: 1 }, 500);									 
		 });
	},function(){
